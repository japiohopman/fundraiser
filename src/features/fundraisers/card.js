  ...
  card.innerHTML = `
    ...
    <div class="point-of-donation-box">
      ...
      <a href="${item.url}" target="_blank" rel="noopener noreferrer" class="donate-btn">
        <svg class="donate-btn-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" aria-hidden="true" width="18" height="18">
        ...
        <span>${labels.donateLink[lang]}</span>
        <span class="visually-hidden">(${titleText})</span>
      </a>
    </div>
