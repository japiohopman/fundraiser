...
export function createFundraiserCard(item, labels, shareContent, lang, contentData, state) {
  ...
  card.innerHTML = `
    ...
    <div class="card-actions">
      <div class="primary-actions">
        ${contextBtnHTML}
        <a href="${item.donateUrl || item.url}" target="_blank" rel="noopener noreferrer" class="donate-btn" aria-label="${lang === 'en' ? 'Donate to' : 'Doneer aan'} ${identityName} (${titleText})">
  ...
  const qrTargetUrl = item.donateUrl || item.url;
